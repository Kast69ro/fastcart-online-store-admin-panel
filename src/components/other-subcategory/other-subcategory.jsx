...
import {
  ...
  deleteSubCategory,
  editSubCategory,
} from "../../entities/api/sub-category/sub-categore";
...
const OtherSubCategory = () => {
  ...
  const handleAddSubCategory = () => {
    dispatch(
      addSubCategory({
        subCategoryName: addSubCategoryName.trim(),
        ...
        <div className="text-base">
          {data?.map((category) =>
            category.subCategories?.map((sub) => (
              <div
                key={sub.id}
                className="flex justify-between pt-2 pb-4 border-b-[1px] border-gray-300"
              >
                <div>
                ...
                <div className="flex gap-3">
                  <div
                    onClick={() =>
                      openEditDialog(sub.id, sub.subCategoryName, category.id)
                    }
